        ...
        <div className="row align-items-center text-center justify-content-center">
            ...
            <div className="row align-items-center text-center justify-content-center background-light-grey p-1 my-4">
                <div className="col-12 ">
                    <span className="font-menu-header ">Популярные товары</span>
                </div>
            </div>
            <div className="row align-items-center text-center justify-content-center ">
            ...
            <div className="row align-items-center text-center justify-content-center background-light-grey p-1 my-4">
                <div className="col-12 ">
                    <span className="font-menu-header ">О нас</span>
                </div>
            </div>
            <div className="row align-items-center text-center justify-content-center">
                <div className="col-3">
                ...
                <div className="col-6">
                    <span>Дело, которым мы занимаемся - это любимый и увлекательный процесс.
...
Каждый день мы стараемся для того, чтобы вы смогли окружить себя красотой и гармонией
            ...
            <div className="row align-items-center text-center justify-content-center background-light-grey p-1 my-4">
                <div className="col-12 ">
                    <span className="font-menu-header ">Доставка</span>
                </div>
            </div>
            <div className="row align-items-center text-center justify-content-center">
                <div className="col-3">
                ...
                <div className="col-3">
                    <span>Наши свечи- вещь хрупкая, имеющая деликатные детали, поэтому мы бережно упаковываем и отправляем вам
Все заказы, тщательно упакованы и имеют на коробках пометку "хрупкое".
            ...
            <div className="row align-items-center text-center justify-content-center background-light-grey p-1 my-4">
                <div className="col-12 ">
                    <span className="font-menu-header ">Ваш бренд</span>
                </div>
            </div>
        </>
